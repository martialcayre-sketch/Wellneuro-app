-- Contrat du compteur de « Voir les sources et limites » ([[D-194]]).
--
...
-- `praticien_email` sans qu'aucun banc ne bronche, et `D-194` deviendrait faux
...
BEGIN
  ...
  IF colonnes IS DISTINCT FROM ARRAY['compte:integer','espece:text','jour:date'] THEN
    RAISE EXCEPTION
      ...
      'timestamp, rendrait FAUSSE la garantie centrale de D-194 : que cette table ne '
