...
-- >>> PAIRES_FIXTURES
  ...
  FROM (VALUES
    ...
    -- règle du décor : `prescriptif` SUIT `exige_prescriptif`. Elles ne
    -- reproduisent donc pas la production, où sept des quatorze sont
    -- prescriptives — et c'est voulu. Le décor est construit pour éprouver le
    -- PRÉDICAT, pas pour mimer le corpus : insérer `false` est le cas le plus
    -- défavorable, celui qui lèverait si l'exemption de [[D-046]] ne
    -- fonctionnait pas.
    ('WN-CL-0320-003', 'v1.0', 'conduites', false),
    ('WN-CL-0318-020', 'v1.0', 'conduites', false),
    ('WN-CL-0315-001', 'v1.0', 'conduites', false),
