...
--   * la QUARANTAINE sanitaire (`lifecycleStatus: quarantined`) : 8 sources du
--     périmètre, dont WN-SRC-0318 (« premières ordonnances », vigilance Élevée)
--     et WN-SRC-0370 (addictions et sevrage). La décision f du 2026-08-01
--     réintègre des DOMAINES ; elle ne lève aucune quarantaine ;
...
AS $$
  VALUES
    ...
    ('WN-SRC-0319'), ('WN-SRC-0320'), ('WN-SRC-0321'), ('WN-SRC-0323'), ('WN-SRC-0324'), ('WN-SRC-0325'),
    ('WN-SRC-0326'), ('WN-SRC-0330'), ('WN-SRC-0333'), ('WN-SRC-0334'), ('WN-SRC-0335'), ('WN-SRC-0336'),
    ...
    ('WN-SRC-0356'), ('WN-SRC-0357'), ('WN-SRC-0359'), ('WN-SRC-0360'), ('WN-SRC-0361'), ('WN-SRC-0363'),
    ('WN-SRC-0364'), ('WN-SRC-0365'), ('WN-SRC-0366'), ('WN-SRC-0367'), ('WN-SRC-0368'), ('WN-SRC-0369'),
    ('WN-SRC-0371'), ('WN-SRC-0372'), ('WN-SRC-0373'), ('WN-SRC-0374'), ('WN-SRC-0375'), ('WN-SRC-0376'),
    ('WN-SRC-0377'), ('WN-SRC-0378'), ('WN-SRC-0379'), ('WN-SRC-0380'), ('WN-SRC-0381'), ('WN-SRC-0382'),
    ('WN-SRC-0383'), ('WN-SRC-0384'), ('WN-SRC-0385'), ('WN-SRC-0386'), ('WN-SRC-0387'), ('WN-SRC-0388'),
    ('WN-SRC-0390'), ('WN-SRC-0391')
$$;

COMMENT ON FUNCTION public.rag_claim_orientation_sources() IS
  'Sources du périmètre d''orientation adaptative au 2026-08-01 : corpus NNPP2_Annee2, notebooks 02-07 et 11, hors quarantaine sanitaire et hors perfusion (A-009 amendé, décision f). Conservée pour que le contrat rag_claim_usage_orientation_v1.sql puisse l''éprouver et qu''un rejeu reste vérifiable.';
