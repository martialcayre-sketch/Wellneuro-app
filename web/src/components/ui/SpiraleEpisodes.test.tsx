...
const cycles: TrajectoireCycle[] = [
  { cycleId: 'ep_a', ancre: 'T0', dateAncre: '2026-01-01T00:00:00.000Z', versionScore: 'v1', jalons: jalonsVides, momentum: null, momentumParBesoin: [] },
  { cycleId: 'ep_b', ancre: 'T0', dateAncre: '2026-03-01T00:00:00.000Z', versionScore: 'v1', jalons: jalonsVides, momentum: null, momentumParBesoin: [] },
];
