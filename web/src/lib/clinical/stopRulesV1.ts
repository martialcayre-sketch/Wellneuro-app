...
export const STOP_RULES_ECARTEES_V1: StopRuleEcartee[] = [
  {
    ...
    id: 'STOP-SOM',
    motif:
      "La spécification l'énonce sur « PSQI 5 », valeur à laquelle la table d'orientation SIGNÉE dit que R-SOM-01 doit s'allumer : sa zone couvrait la bande `info` du PSQI, qui allait alors de 5 à 10. CE MOTIF EST PÉRIMÉ DEPUIS LE 2026-09-13 : l'arbitrage praticien du même jour a déplacé la borne de la grille, `info` couvre désormais 6-10, et `R-SOM-01` ne s'allume plus à 5. La contradiction qui fondait ce refus a donc DISPARU — écrire STOP-SOM sur « PSQI 5 » n'éteindrait plus une règle signée à la valeur où elle s'allume. Ce qui reste à trancher est la seconde jambe, ci-dessous, et la question de fond que D-177 avait nommée : un claim prescriptif attachant une conduite à la bande rassurante. L'écrire reviendrait à éteindre en V1 une règle signée le mois dernier sur la même valeur, sans re-signer la table. Sa seconde jambe, l'agenda du sommeil Q_SOM_09, porte deux réserves propres : son indice /100 est une construction WellNeuro sans validation psychométrique ni cohorte de calibration, et D-052 l'a déjà exclu du rideau T0 au motif qu'un recueil de 21 nuits ne conditionne pas une décision prise à J0 — la même objection vaut en miroir pour une extinction.",
    conditionDeRetour:
