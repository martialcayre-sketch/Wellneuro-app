...
const { prisma, getLatestActivation, readPatientSession, isSessionValideForPatient } = vi.hoisted(() => ({
  prisma: {
...
describe('api/portail/ja/decision', () => {
  ...
  it('GET refuse si la session n est plus valide pour le compte', async () => {
