...
- Date : 2026-08-03
- Statut : accepté (clôture du LOT-01 de la campagne `2026-08-03-packs-moteur-d-intervention-et-corpus-consommable`) — **le contrat qui matérialise cette décision est livré par la PR #553, non mergée au 2026-08-03** : la décision est prise, sa mise en œuvre n'est pas encore sur `main`.
