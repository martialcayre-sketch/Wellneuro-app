...
| 2 | **SP-RUN** — Cockpit vivant | `2026-07-15-cockpit-vivant` | praticien | Câbler le runtime C1 : `ClinicalSnapshot`/`ClinicalReview`/`DecisionCard` calculés depuis les vraies réponses (le cockpit est aujourd'hui branché sur `null`) | **validation ergonomique praticien** (DoD C1 restante — seul l'utilisateur la lève) |
...
| 10 | **JA** — Ma spirale alimentaire | `2026-07-13-journal-alimentaire-21j-v1` | patient | Recadrée 5.0 (A7) : essai d'action, capture occasion/praticabilité/friction, budget d'attention, droit au silence — météo agrégée déportée en SP-MET | audit JA-00 ; persistance : C2A |
