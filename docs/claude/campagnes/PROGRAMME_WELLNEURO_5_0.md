...
| 5 | **SP-TT** — Time-travel | `2026-07-19-sp-tt-time-travel-relecture` | praticien | Fiche rechargée à une date passée (snapshots immuables) + **note de relecture** horodatée au présent | C2A + C2B |
| 6 | **SP-COP** — Copilote pré-vol & minute d'après | `2026-07-19-sp-cop-copilote-consultation` | praticien | Pré-vol T-10 min (changements, discordances sourcées, questions suggérées) + clôture (décision/protocole/document pré-remplis, trois relectures) — **sans écoute ambiante** | SP-RUN + C2A ; C3 pour les documents |
...
| 8 | **IDP** — Identité patient durable | `2026-07-19-idp-identite-patient-durable` (= R8/E3 roadmap produit) | patient | Magic link e-mail + passkeys (WebAuthn). Fondation de la Phase B (la Spirale au sens propre exige des tours multiples) | — |
| 9 | **SP-SPI** — Ma spirale & reprise | `2026-07-19-sp-spi-ma-spirale-patient` | patient | Accueil patient trajectoire (« Ma spirale »), reprise en douceur (« voici où vous vous étiez arrêté »), **pack de réévaluation pré-composé proposé** — jamais auto-assigné | IDP + C2A |
...
| 11 | **SP-MET** — Météo d'adhésion | `2026-07-19-sp-met-meteo-adhesion` | praticien | Signal 3 états (régulière/fragile/interrompue), cause observable citée, **jamais affichée côté patient** | C2A + JA |
| 12 | **SP-CONV** — Convergence Spirale 5.0 : trajectoire partagée | `2026-07-22-sp-conv-trajectoire-partagee` | deux | Contrat d'épisode partagé (deux formulations), phase initiale calculée du cockpit, suture index Spirale ↔ time-travel `asOf`, étapes patient 5-6 synchronisées, « Mon équilibre » qualitatif, renommage A7, baselines visuelles | cadrée le 2026-07-22 ; sans migration (cycles G2 ✓, SP-TT ✓) ; activation à la gouvernance |
| 13 | **SP-CAB** — Cabinet apprenant | à cadrer | praticien | Repère médiane de momentum, `n=` toujours affiché, masqué sous **n ≥ 5** épisodes clos (constante ajustable) | épisodes clos en nombre suffisant |
| 14 | **SP-AMB** — Écoute ambiante | à cadrer | praticien | Consentement **double niveau** (document signé au dossier + activation visible par séance), notes structurées en brouillon, non-conservation de l'audio | **cadre CNIL/RGPD instruit et validé avant tout développement** |
