...
| à cadrer | **La Boussole alimentaire : l'assiette, l'aliment, et lequel devient une action** | `CADRAGE_BOUSSOLE_ASSIETTE_2026-09-16.md` | **CADRÉE LE 2026-09-16**, sur une réflexion posée en session : « choisir un aliment dans la Boussole comme action me paraît incongru ». **L'état réel désamorce la moitié de la question** : `attachFoodCompassRef` attache bien une référence d'aliment à une action, mais **aucune route ni composant ne l'appelle** — seul son banc le lance, et `WN_C5_ENABLED` commande son refus. Rien à défaire en production. **L'assiette a déjà son catalogue** — `C5B_RECOMMENDED_PLATES`, trois entrées au cadrage, **quinze depuis [[D-230]]** (les douze du corpus sont entrées, sur un second axe), `contentHash` par entrée et hachage de catalogue — et son unique consommateur reste le panneau d'**observation**, qui ne voit que les trois repères de moment de repas. Le corpus tranche dans le même sens : **119 actions de domaine « assiette » contre 3 documents « aliment vedette » sur 123**, et le seul précédent corpus → table signée → runtime (`WN-CL-0287-009`) fonde l'indication d'une **assiette**. **Le cadrage refuse la substitution** et sépare trois rôles : l'assiette devient l'unité qui porte une action, l'aliment vedette devient le contenu d'un plan, la Boussole reste une surface de compréhension patient. Quatre arbitrages, aucun bloquant hors B1. |
...
- **Le registre TRUST patient promet une garde que le logiciel ne tient pas** —
  ...
  [[D-219]] §3 confie pourtant la règle au praticien, informé. Ce sont des
