...
| D4 | **Clôture de suivi** : accès en lecture conservé, **aucune assignation de questionnaire, aucun envoi de document _de suivi_**. Le lien d'accès au portail, lui, reste envoyable (précisé le 2026-07-21) | Un dossier clos n'est pas un dossier actif au ralenti. La précision est nécessaire : la lecture des archives est promise, et un patient ayant perdu son e-mail n'aurait plus de porte si le renvoi du lien était bloqué. Un lien d'accès n'est pas un document de suivi |
