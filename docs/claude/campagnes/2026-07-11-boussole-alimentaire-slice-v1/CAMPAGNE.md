...
| LOT-02 | Référentiel Ciqual et gate migration | **en_attente_confirmation_migration** | plan et dry-run source vérifiés ; gate migration puis gate import distincts |
