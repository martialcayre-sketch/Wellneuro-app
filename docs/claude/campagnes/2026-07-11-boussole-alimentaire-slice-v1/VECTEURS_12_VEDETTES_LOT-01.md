...
- `availableWeight = somme des poids originaux disponibles` ;
- `renormalizedWeight_i = originalWeight_i / availableWeight x 100` ;
- `contribution_i = alignment_i x renormalizedWeight_i` ;
- `expectedAggregate = somme(contribution_i)`.
...
| Composante | Valeur [confiance] | Alignement | Poids initial | Poids renormalisé | Contribution |
|---|---:|---:|---:|---:|---:|
| Protéines `25000` | 18,1 [A] | 0,696154 | 18 % | 19,7802 % | 13,770070 |
| Sucres `32000` | traces [D] | — | 9 % | — | — |
| Fibres `34100` | 0 [D] | 0,000000 | 13,5 % | 14,8352 % | 0,000000 |
| AG saturés `40302` | 3,22 [A] | 0,820112 | 9 % | 9,8901 % | 8,110995 |
| AG monoinsaturés `40303` | 4,03 [A] | 0,266887 | 4,5 % | 4,9451 % | 1,319773 |
| AG polyinsaturés `40304` | 3,91 [A] | 0,624551 | 4,5 % | 4,9451 % | 3,088438 |
| ALA `41833` | 0,12 [A] | 0,173035 | 6,3 % | 6,9231 % | 1,197937 |
| EPA `42053` | 0,91 [A] | 1,000000 | 5,4 % | 5,9341 % | 5,934066 |
| DHA `42263` | 1,56 [A] | 1,000000 | 6,3 % | 6,9231 % | 6,923077 |
| Sel `10004` | 0,16 [A] | 0,933012 | 13,5 % | 14,8352 % | 13,841391 |
| PRAL | 7,95664 [A/A/A/A/A] | 0,287941 | 10 % | 10,9890 % | 3,164187 |
...
| Composante | Valeur [confiance] | Alignement | Poids initial | Poids renormalisé | Contribution |
|---|---:|---:|---:|---:|---:|
| Protéines `25000` | 10,1 [D] | 0,388461 | 18 % | 20,3851 % | 7,918796 |
| Sucres `32000` | 0,2 [D] | 0,994684 | 9 % | 10,1925 % | 10,138346 |
| Fibres `34100` | 8,45 [D] | 0,938889 | 13,5 % | 15,2888 % | 14,354473 |
| AG saturés `40302` | 0,092 [D] | 0,994860 | 9 % | 10,1925 % | 10,140139 |
| AG monoinsaturés `40303` | 0,13 [D] | 0,008609 | 4,5 % | 5,0963 % | 0,043875 |
| AG polyinsaturés `40304` | 0,18 [D] | 0,028752 | 4,5 % | 5,0963 % | 0,146526 |
| ALA `41833` | 0,032 [D] | 0,046143 | 6,3 % | 7,1348 % | 0,329218 |
| EPA `42053` | < 0,01 [D] | — | 5,4 % | — | — |
| DHA `42263` | < 0,01 [D] | — | 6,3 % | — | — |
| Sel `10004` | 0,015 [D] | 0,995356 | 13,5 % | 15,2888 % | 15,217794 |
| PRAL | 4,92470 [D/D/D/D/D] | 0,417547 | 10 % | 11,3250 % | 4,728735 |
...
| Composante | Valeur [confiance] | Alignement | Poids initial | Poids renormalisé | Contribution |
|---|---:|---:|---:|---:|---:|
| Protéines `25000` | 8,31 [A] | 0,319615 | 18 % | 20,3851 % | 6,515363 |
| Sucres `32000` | 0,3 [A] | 0,992027 | 9 % | 10,1925 % | 10,111256 |
| Fibres `34100` | 8,2 [A] | 0,911111 | 13,5 % | 15,2888 % | 13,929785 |
| AG saturés `40302` | 0,46 [A] | 0,974302 | 9 % | 10,1925 % | 9,930595 |
| AG monoinsaturés `40303` | 0,82 [A] | 0,054305 | 4,5 % | 5,0963 % | 0,276751 |
| AG polyinsaturés `40304` | 1,59 [A] | 0,253973 | 4,5 % | 5,0963 % | 1,294315 |
| ALA `41833` | 0,08 [A] | 0,115357 | 6,3 % | 7,1348 % | 0,823045 |
| EPA `42053` | < 0,01 [A] | — | 5,4 % | — | — |
| DHA `42263` | < 0,01 [A] | — | 6,3 % | — | — |
| Sel `10004` | 0,027 [A] | 0,990197 | 13,5 % | 15,2888 % | 15,138911 |
| PRAL | 3,60190 [A/A/A/A/A] | 0,474093 | 10 % | 11,3250 % | 5,369116 |
...
| Composante | Valeur [confiance] | Alignement | Poids initial | Poids renormalisé | Contribution |
|---|---:|---:|---:|---:|---:|
| Protéines `25000` | 13,3 [A] | 0,511538 | 18 % | 24,0642 % | 12,309738 |
| Sucres `32000` | 3 [A] | 0,920266 | 9 % | 12,0321 % | 11,072717 |
| Fibres `34100` | 6,7 [A] | 0,744444 | 13,5 % | 18,0481 % | 13,435829 |
| AG saturés `40302` | 6,45 [A] | 0,639665 | 9 % | 12,0321 % | 7,696502 |
| AG monoinsaturés `40303` | 14,1 [A] | 0,933775 | 4,5 % | 6,0160 % | 5,617629 |
| AG polyinsaturés `40304` | 43,6 [A] | 1,000000 | 4,5 % | 6,0160 % | 6,016043 |
| ALA `41833` | 7,5 [A] | 1,000000 | 6,3 % | 8,4225 % | 8,422460 |
| EPA `42053` | < 0,01 [A] | — | 5,4 % | — | — |
| DHA `42263` | < 0,01 [A] | — | 6,3 % | — | — |
| Sel `10004` | < 0,13 [A] | — | 13,5 % | — | — |
| PRAL | 6,19200 [A/A/A/A/A] | 0,363374 | 10 % | 13,3690 % | 4,857942 |
...
| Composante | Valeur [confiance] | Alignement | Poids initial | Poids renormalisé | Contribution |
|---|---:|---:|---:|---:|---:|
| Protéines `25000` | 8,66 [A] | 0,333076 | 18 % | 20,3851 % | 6,789777 |
| Sucres `32000` | 2,41 [A] | 0,935947 | 9 % | 10,1925 % | 9,539662 |
| Fibres `34100` | 7,3 [A] | 0,811111 | 13,5 % | 15,2888 % | 12,400906 |
| AG saturés `40302` | 0,56 [A] | 0,968715 | 9 % | 10,1925 % | 9,873653 |
| AG monoinsaturés `40303` | 0,31 [A] | 0,020530 | 4,5 % | 5,0963 % | 0,104625 |
| AG polyinsaturés `40304` | 0,74 [A] | 0,118201 | 4,5 % | 5,0963 % | 0,602386 |
| ALA `41833` | 0,052 [A] | 0,074982 | 6,3 % | 7,1348 % | 0,534979 |
| EPA `42053` | < 0,002 [A] | — | 5,4 % | — | — |
| DHA `42263` | < 0,002 [A] | — | 6,3 % | — | — |
| Sel `10004` | 1,17 [A] | 0,498753 | 13,5 % | 15,2888 % | 7,625331 |
| PRAL | 2,75360 [A/A/A/A/A] | 0,510355 | 10 % | 11,3250 % | 5,779788 |
...
| Composante | Valeur [confiance] | Alignement | Poids initial | Poids renormalisé | Contribution |
|---|---:|---:|---:|---:|---:|
| Protéines `25000` | 3,17 [D] | 0,121922 | 18 % | 20,3851 % | 2,485391 |
| Sucres `32000` | 1,06 [D] | 0,971827 | 9 % | 10,1925 % | 9,905374 |
| Fibres `34100` | 2,59 [D] | 0,287778 | 13,5 % | 15,2888 % | 4,399773 |
| AG saturés `40302` | 0,2 [D] | 0,988827 | 9 % | 10,1925 % | 10,078643 |
| AG monoinsaturés `40303` | 0,17 [D] | 0,011258 | 4,5 % | 5,0963 % | 0,057375 |
| AG polyinsaturés `40304` | 0,19 [D] | 0,030349 | 4,5 % | 5,0963 % | 0,154667 |
| ALA `41833` | 0,12 [D] | 0,173035 | 6,3 % | 7,1348 % | 1,234567 |
| EPA `42053` | < 0,01 [D] | — | 5,4 % | — | — |
| DHA `42263` | < 0,01 [D] | — | 6,3 % | — | — |
| Sel `10004` | 0,036 [D] | 0,986327 | 13,5 % | 15,2888 % | 15,079749 |
| PRAL | -1,89590 [D/D/D/D/D] | 0,709107 | 10 % | 11,3250 % | 8,030660 |
...
| Composante | Valeur [confiance] | Alignement | Poids initial | Poids renormalisé | Contribution |
|---|---:|---:|---:|---:|---:|
| Protéines `25000` | 3,2 [A] | 0,123076 | 18 % | 21,2515 % | 2,615548 |
| Sucres `32000` | traces [A] | — | 9 % | — | — |
| Fibres `34100` | 2,7 [A] | 0,300000 | 13,5 % | 15,9386 % | 4,781582 |
| AG saturés `40302` | 0,054 [D] | 0,996983 | 9 % | 10,6257 % | 10,593683 |
| AG monoinsaturés `40303` | 0,0045 [D] | 0,000298 | 4,5 % | 5,3129 % | 0,001583 |
| AG polyinsaturés `40304` | 0,082 [D] | 0,013098 | 4,5 % | 5,3129 % | 0,069588 |
| ALA `41833` | absent | — | 6,3 % | — | — |
| EPA `42053` | 0 [C] | 0,000000 | 5,4 % | 6,3754 % | 0,000000 |
| DHA `42263` | 0 [C] | 0,000000 | 6,3 % | 7,4380 % | 0,000000 |
| Sel `10004` | 0,069 [A] | 0,972139 | 13,5 % | 15,9386 % | 15,494535 |
| PRAL | -8,50240 [A/A/A/A/A] | 0,991515 | 10 % | 11,8064 % | 11,706200 |
...
| Composante | Valeur [confiance] | Alignement | Poids initial | Poids renormalisé | Contribution |
|---|---:|---:|---:|---:|---:|
| Protéines `25000` | 0,87 [B] | 0,033461 | 18 % | 19,2102 % | 0,642787 |
| Sucres `32000` | 9,96 [B] | 0,735282 | 9 % | 9,6051 % | 7,062478 |
| Fibres `34100` | 2,4 [B] | 0,266667 | 13,5 % | 14,4077 % | 3,842049 |
| AG saturés `40302` | 0,028 [C] | 0,998436 | 9 % | 9,6051 % | 9,590098 |
| AG monoinsaturés `40303` | 0,047 [C] | 0,003113 | 4,5 % | 4,8026 % | 0,014948 |
| AG polyinsaturés `40304` | 0,15 [C] | 0,023960 | 4,5 % | 4,8026 % | 0,115068 |
| ALA `41833` | absent | — | 6,3 % | — | — |
| EPA `42053` | 0 [C] | 0,000000 | 5,4 % | 5,7631 % | 0,000000 |
| DHA `42263` | 0 [C] | 0,000000 | 6,3 % | 6,7236 % | 0,000000 |
| Sel `10004` | 0,0025 [B] | 1,000000 | 13,5 % | 14,4077 % | 14,407684 |
| PRAL | -0,98070 [B/B/B/B/B] | 0,669985 | 10 % | 10,6724 % | 7,150323 |

Composante absente : ALA. Agrégat attendu : **42,825435**.
