...
> `docs/claude/handoffs/` puis `docs/claude/lots/`. Les quatre premiers lots
> sont déjà livrés et fusionnés sur `main` ; le cinquième (surface de saisie
> patient) reste à faire.
...
| `LOT-04-portail-saisie.md` | L4b | à faire | déplacé depuis `docs/claude/lots/2026-08-04-agenda-alimentaire-l4b.md` |
...
`LOT-03`) et **D-018** (borne des 21 jours par la date, drapeau posé après la
surface — arbitrage pris avant `LOT-04`).
...
| LOT-04 | Portail patient : aiguillage, hub, saisie, borne des 21 jours | à faire | LOT-03 |
