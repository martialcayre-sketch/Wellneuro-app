...
8. `lots/LOT-00-audit-arbitrages.md` — première action autorisée.
...
Ne pas commencer directement par le thème ou les composants. LOT-00 doit d'abord classifier les écrans et les questionnaires. En cas d'incertitude sur un instrument, sa politique est `strict`.
