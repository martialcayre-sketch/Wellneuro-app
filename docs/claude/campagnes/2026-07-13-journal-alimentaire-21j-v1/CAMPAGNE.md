...
| JA5-02 | Parcours patient : question du jour, plan minimal, solutions intra-épisode, parité papier (carte A6 imprimable + saisie praticien en 30 s) | **mergé (harnais `/dev/validation-ja`, PR #134, 2026-07-18)** — dettes ouvertes : voir `DETTE_JA.md` |
...
| JA5-04 | Persistance : épisodes, événements, solutions, carrière d'action, RLS patient-scopé, audit append-only | **terminé (API praticien/portail mergées, sans migration, 2026-07-17)** |
| JA5-05 | Activation : liaison protocole actif, jalons, PhaseReview avec delta, retour de décision, charge perçue, budget de charge global protocole (avec C2A) | **en cours (API + UI initiales, 2026-07-17)** |
