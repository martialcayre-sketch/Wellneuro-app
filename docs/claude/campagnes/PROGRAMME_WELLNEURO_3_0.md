...
> Révision du 2026-07-13 — intègre les arbitrages du brainstorm (registre de
...
## Proposition de feuille de route 3.2

Le pack WN Ultimate v2 est intégré sous
[`../propositions/wn-ultimate-v2/`](../propositions/wn-ultimate-v2/README.md).
Il propose notamment `ClinicalSnapshot`, `DecisionCard`, `ProtocolDraft`, un
journal alimentaire de 21 jours et un compiler de corpus clinique.

Cette proposition ne remplace pas encore le présent programme : les
frontières C5A/C5B, les décisions cliniques, les droits du corpus et
l'activation de l'outillage doivent être arbitrés. Les apports compatibles
seront promus par lots documentaires courts après ces gates.
