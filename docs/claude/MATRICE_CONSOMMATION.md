...
| Table d’indications d’assiette (11 lignes signées, 7 servables) | 3 surface(s) indirecte(s) seulement | Assiettes indiquées pour un dossier, servies en lecture au cockpit praticien — et ce que le dossier n’a pas permis d’évaluer. | WN_ASSIETTES_INDIQUEES | validationExterne | non | — |
