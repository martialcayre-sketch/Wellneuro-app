...
| Corpus clinique de synthèse V1 | 27 surface(s) indirecte(s) seulement | Cadrage clinique injecté dans la synthèse rédigée par le modèle. | WN_ENABLE_CORPUS_CLINIQUE_V1 | validationExterne | oui | — |
