...
| Table de contradictions NNPP2 (règles signées) | 1 surface(s) indirecte(s) seulement | Constat de contradiction entre instruments, signalé au praticien. | WN_ENABLE_CONTRADICTIONS_NNPP2 | tableSignee, validationExterne | non | — |
