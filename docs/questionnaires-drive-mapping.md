...
| `Q_GAS_02` | `gastro_03_score_francis.md` | certifié | certifié | n/a | certifié | certifié | certifié | Francis, 2 questions filtres non scorées + 5 composants, score 0-500 | **Écart délibéré à Drive (arbitrage 2026-09-15)** : `FR_Q006` porte désormais ses ancres (`0 = très satisfait(e) · 100 = très insatisfait(e)`) — Drive pose la question en satisfaction sur une réglette sans ancre, alors que le moteur compte l'insatisfaction. Et les seuils Drive (<70 / 70-300 / >300) sont remplacés par les quatre catégories publiées (Francis 1997). Ne pas « rétablir » Drive.
