...
Mais `reference_identifiee` n'exige qu'**un** champ d'identification non vide — un nom d'auteur suffit. **12 entrées seulement** (`Q_GAS_02`, `Q_GEO_03`, `Q_GEO_04`, `Q_GEO_05`, `Q_GEO_06`, `Q_NEU_01`, `Q_NEU_11`, `Q_PED_01`, `Q_SOM_01`, `Q_SOM_04`, `Q_SOM_06`, `Q_STR_02`) portent un identifiant vérifiable, DOI ou PMID, dans `references`. L'étiquette dit que la référence est désignable ; elle ne dit pas qu'elle a été retrouvée.
