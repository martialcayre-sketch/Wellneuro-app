...
> contrats et parcours automatisés, sans valider le protocole humain ni
> ouvrir les responsabilités runtime de C2/C3.
...
- [ ] Flux complet comprendre → décider → 3 actions → prévisualiser → valider
      à chronométrer avec un praticien ; les fixtures techniques ne valent
      pas validation ergonomique humaine.
