---
description: Routage manuel d'une demande — modèle, effort, mode d'exécution.
...
Un override nommé par l'utilisateur prime. Sortie uniquement si déviation du
